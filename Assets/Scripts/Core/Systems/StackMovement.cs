...
public class StackMovement : MonoBehaviour
{
    ...
    public float maxReverseFactor = 0.5f; 
    private Vector3 lastParentPos;
    private Vector3[] offsets;
    private float[] sideSwayOffsets; 
    private float[] forwardSwayOffsets; 
    private float[] rollOffsets;       
    ...
    void LateUpdate()
    {
        ...
        float speed = deltaPos.magnitude / Mathf.Max(Time.deltaTime, 0.0001f); 
        Vector3 moveDir = deltaPos.normalized;
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            if (isMoving)
            {
                ...
                targetOffset.z = -moveDir.z * looseness * dynamicReverse; 
            }
